...
import { projectStatusClass, statusDotClass } from "@/lib/status-colors";
                  ...
                  <tbody>
                    {items.map((project) => (
                      ...
                      >
                        ...
                        {/* STATUS */}
                        <td className="px-5 py-4">
                          <span className={`inline-flex items-center gap-1.5 rounded-full px-2.5 py-1 text-xs font-medium ${projectStatusClass(project.status)}`}>
                            <span className={`h-1.5 w-1.5 rounded-full ${statusDotClass(project.status)}`} />
                            {project.status}
                          </span>
                        </td>
